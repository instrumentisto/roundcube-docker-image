...
NAME := roundcube
ALL_IMAGES := \
	1.4/apache:1.4.11-r4-apache,1.4.11-apache,1.4-apache,1-apache,apache,latest \
	1.4/fpm:1.4.11-r4-fpm,1.4.11-fpm,1.4-fpm,1-fpm,fpm \
	1.3/apache:1.3.16-r5-apache,1.3.16-apache,1.3-apache \
	1.3/fpm:1.3.16-r5-fpm,1.3.16-fpm,1.3-fpm
