...
REGISTRIES := $(strip $(subst $(comma), ,\
	$(shell grep -m1 'registry: \["' .github/workflows/ci.yml \
	        | cut -d':' -f2 | tr -d '"][')))
ALL_IMAGES := \
	1.6/apache:1.6.3-r1-apache,1.6.3-apache,1.6-apache,1-apache,apache,latest \
	1.6/fpm:1.6.3-r1-fpm,1.6.3-fpm,1.6-fpm,1-fpm,fpm \
	1.5/apache:1.5.5-r0-apache,1.5.5-apache,1.5-apache \
	1.5/fpm:1.5.5-r0-fpm,1.5.5-fpm,1.5-fpm \
	1.4/apache:1.4.15-r0-apache,1.4.15-apache,1.4-apache \
	1.4/fpm:1.4.15-r0-fpm,1.4.15-fpm,1.4-fpm
