...
REGISTRIES := $(strip $(subst $(comma), ,\
	$(shell grep -m1 'registry: \["' .github/workflows/ci.yml \
	        | cut -d':' -f2 | tr -d '"][')))
ALL_IMAGES := \
	1.6/apache:1.6.1-r7-apache,1.6.1-apache,1.6-apache,1-apache,apache,latest \
	1.6/fpm:1.6.1-r7-fpm,1.6.1-fpm,1.6-fpm,1-fpm,fpm \
	1.5/apache:1.5.3-r15-apache,1.5.3-apache,1.5-apache \
	1.5/fpm:1.5.3-r15-fpm,1.5.3-fpm,1.5-fpm \
