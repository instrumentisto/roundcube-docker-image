...
NAME := roundcube
ALL_IMAGES := \
	1.5/apache:1.5.2-r3-apache,1.5.2-apache,1.5-apache,1-apache,apache,latest \
	1.5/fpm:1.5.2-r3-fpm,1.5.2-fpm,1.5-fpm,1-fpm,fpm \
	1.4/apache:1.4.13-r3-apache,1.4.13-apache,1.4-apache \
	1.4/fpm:1.4.13-r3-fpm,1.4.13-fpm,1.4-fpm \
	1.3/apache:1.3.17-r4-apache,1.3.17-apache,1.3-apache \
	1.3/fpm:1.3.17-r4-fpm,1.3.17-fpm,1.3-fpm
