...
ALL_IMAGES := \
	1.4/apache:1.4.5-apache,1.4-apache,1-apache,apache,latest \
	1.4/fpm:1.4.5-fpm,1.4-fpm,1-fpm,fpm \
	1.3/apache:1.3.12-apache,1.3-apache \
	1.3/fpm:1.3.12-fpm,1.3-fpm
